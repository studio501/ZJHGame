...
const Player = function (spec) {
    ...
    _socket.on("pk_choose_player",function (uid) {
        ...
        _event.fire("player_pk",{uid:_uid,targetUid:uid});
    });
    ...
    const pushCard = function () {
        console.log("socket emit push_card");
    ...
    const playerChooseRate = function (data) {
        console.log("send player choose rate %j",data);
    ...
    that.destroy = function () {
        ...
        _event.off("update_player_rate",playerChooseRate);
